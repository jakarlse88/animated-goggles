...
namespace Demelain.AuthServer.Services
{
    public class DemelainReturnUrlParser: IReturnUrlParser
    {
        ...
        public bool IsValidReturnUrl(string returnUrl)
        {
            ...
            if (returnUrl.IsLocalUrl() || returnUrl.StartsWith(_configuration["ValidReturnUrl"]))
            {
